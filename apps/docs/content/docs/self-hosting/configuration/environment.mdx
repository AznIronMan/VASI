...
| Variable                      | Description                                                                              | Default     |
| ----------------------------- | ---------------------------------------------------------------------------------------- | ----------- |
| `NEXT_PRIVATE_SMTP_TRANSPORT` | Email transport: `smtp-auth`, `smtp-api`, `microsoft-graph`, `resend`, or `mailchannels` | `smtp-auth` |

### Microsoft Graph (microsoft-graph)

| Variable                                          | Default | Description                                   |
| ------------------------------------------------- | ------- | --------------------------------------------- |
| `NEXT_PRIVATE_MICROSOFT_GRAPH_TENANT_ID`          | -       | Microsoft Entra tenant ID                     |
| `NEXT_PRIVATE_MICROSOFT_GRAPH_CLIENT_ID`          | -       | Dedicated application client ID               |
| `NEXT_PRIVATE_MICROSOFT_GRAPH_CLIENT_SECRET`      | -       | Application client secret                     |
| `NEXT_PRIVATE_MICROSOFT_GRAPH_CLIENT_SECRET_FILE` | -       | File containing the application client secret |

Set either `NEXT_PRIVATE_MICROSOFT_GRAPH_CLIENT_SECRET` or its
`NEXT_PRIVATE_MICROSOFT_GRAPH_CLIENT_SECRET_FILE` counterpart, not both.
...
| `NEXT_PRIVATE_SMTP_REQUIRE_TLS`       | `false`     | Require STARTTLS (`true` or `false`)     |

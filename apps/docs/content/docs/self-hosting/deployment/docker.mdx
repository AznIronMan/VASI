...
| `NEXT_PRIVATE_SMTP_SECURE`   | No       | `false`     | Use implicit TLS (normally port 465)  |
| `NEXT_PRIVATE_SMTP_REQUIRE_TLS` | No    | `false`     | Require STARTTLS (normally port 587)  |
...
<Accordions type="multiple">
  ...
  <Accordion title="Emails not sending">
    ...
    requires implicit TLS (`NEXT_PRIVATE_SMTP_SECURE=true`) or mandatory STARTTLS

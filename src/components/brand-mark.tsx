export function BrandMark({ compact = false }: { compact?: boolean }) {
  return (
    <div className={`brand-mark${compact ? " brand-mark--compact" : ""}`} aria-label="CNB V Sign">
      ...
      <span className="brand-mark__type">
        <span className="brand-mark__company">CNB</span>
        <span className="brand-mark__divider" aria-hidden="true" />
        <span className="brand-mark__product">V·SIGN</span>
      </span>
    </div>
  );
}

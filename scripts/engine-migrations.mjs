...
export const ENGINE_MIGRATIONS = Object.freeze([
  ...
  {
    name: "0015_engine_tenant_admission",
    path: path.join(repositoryRoot, "database", "engine-tenant-admission.sql"),
  },
  {
    name: "0016_engine_tenant_production_stop",
    path: path.join(repositoryRoot, "database", "engine-tenant-production-stop.sql"),
  },
  {
    name: "0017_engine_tenant_provision_replay",
    path: path.join(repositoryRoot, "database", "engine-tenant-provision-replay.sql"),
  },
  {
    name: "0018_engine_participant_data_delivery",
    path: path.join(repositoryRoot, "database", "engine-participant-data-delivery.sql"),
  },
